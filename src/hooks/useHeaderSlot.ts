...
export function useHeaderSlot(
  ...
  options: { hideDefaultActions?: boolean } = {},
) {
  ...
  const hideDefaultActions = options.hideDefaultActions ?? false
  ...
  useEffect(() => {
    ...
    setHideDefaultActions(hideDefaultActions)
  }, [hideDefaultActions, left, right, setHeaderLeft, setHeaderRight, setHideDefaultActions])
