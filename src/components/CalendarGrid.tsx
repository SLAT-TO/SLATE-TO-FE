...
export function CalendarGrid({
  ...
  return (
    <div className="flex h-full w-full flex-col">
      {/* 요일 헤더 */}
      <div className="grid shrink-0 grid-cols-7" style={{ height: CALENDAR_HEADER_HEIGHT_PX }}>
      ...
      {weeks.map((week, weekIndex) => (
        <div key={toDateKey(week[0])} className="border-border relative min-h-0 flex-1 border-l">
            ...
            {week.map((day) => {
              ...
              return (
                <div
                  ...
                  className={`border-border flex flex-col items-start gap-2.5 border-r border-b pt-2 pl-2 ${
