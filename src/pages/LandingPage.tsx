...
function ArrowForwardIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      <path d="M2 11a1 1 0 1 0 0 2h14.586l-3.293 3.293a1 1 0 1 0 1.414 1.414l5-5a1 1 0 0 0 0-1.414l-5-5a1 1 0 1 0-1.414 1.414L16.586 11H2Z" />
    </svg>
  )
}
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white">
      ...
      <div className="relative z-10 flex min-h-screen flex-col gap-16 px-8 pt-16 pb-16 md:px-20 md:pt-24">
        <p className="font-logo text-lg tracking-tight text-white">SLATE - TO</p>

        <div className="flex max-w-xl flex-col gap-[52px]">
